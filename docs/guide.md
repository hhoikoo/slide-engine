...
8. 강조 박스 섹션 (highlight-boxes):
 ...
 색은 end-product-list 와 같은 팔레트를 꽉 찬 띠로 씁니다.
 1번 주황, 2번 녹색, 3번 파랑, 4번 보라, 5번 적색, 6번 다크 네이비.

 흰 글자 대비는 21px bold 기준(3:1)으로 잰 값이 아래와 같습니다.
   주황 2.85:1, 녹색 2.87:1, 파랑 4.30:1, 보라 5.87:1, 적색 5.44:1, 네이비 17.39:1
 앞의 두 색은 기준에 못 미칩니다. 1번과 2번에 긴 제목을 얹을 때는
 --hbox-color-N 으로 더 어두운 같은 계열 색을 지정하십시오.
